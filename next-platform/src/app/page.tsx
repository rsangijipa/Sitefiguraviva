...
import { ArrowRight, Calendar, ExternalLink, Heart, MessageCircle, FileText, ChevronDown, Users } from 'lucide-react';
                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col lg:flex-row gap-24 items-center">
                        ...
                        <motion.div
                            ...
                            className="lg:w-[60%] w-full bg-white p-3 shadow-[0_60px_100px_-20px_rgba(0,0,0,0.1)] rounded-[2.5rem] border border-primary/5 lazy-load"
                        >
