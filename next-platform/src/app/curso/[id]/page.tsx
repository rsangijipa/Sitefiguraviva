...
import { Calendar, MapPin, Clock, ArrowLeft, ExternalLink, X } from 'lucide-react';
...
export default function CourseDetail() {
    ...
    if (!course) return (
        <div className="min-h-screen bg-paper flex flex-col items-center justify-center gap-6">
            <h1 className="font-serif text-3xl">Curso não encontrado.</h1>
            <button onClick={() => window.location.href = '/#instituto'} className="text-accent underline uppercase tracking-widest text-xs font-bold">Voltar para Início</button>
        </div>
    );
                ...
                <div className="container mx-auto px-6 max-w-6xl relative">
                    ...
                    <div className="grid md:grid-cols-12 gap-12">
                        <div className="md:col-span-8 space-y-16">
                            ...
                            {course.details?.format && Array.isArray(course.details.format) && (
                        ...
                        <div className="md:col-span-4 space-y-8">
                            {course.details?.schedule && Array.isArray(course.details.schedule) && (
                                <div className="bg-stone-50 p-8 rounded-2xl border border-stone-100 sticky top-32">
                                    <div className="flex items-center gap-3 mb-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-primary/50">{course.details.schedule.length} Encontros</p>
                                        </div>
                                    </div>
