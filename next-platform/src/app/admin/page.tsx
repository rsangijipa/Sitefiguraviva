    ...
    return (
        <div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                {stats.map((stat, idx) => (
                    <motion.div
                        ...
                        className="bg-white p-8 rounded-[2rem] shadow-[0_20px_40px_-10px_rgba(0,0,0,0.05)] border border-primary/5 hover:border-gold/30 transition-soft group"
                    >
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="bg-primary text-paper p-10 rounded-[2.5rem] relative overflow-hidden">
                    ...
                    <button className="w-full py-4 bg-gold rounded-xl text-primary font-bold uppercase text-[10px] tracking-widest hover:bg-white transition-colors relative z-10">
                        Ver Agenda
                    </button>
                </div>
            </div>
