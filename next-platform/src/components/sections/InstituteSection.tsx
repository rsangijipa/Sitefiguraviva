    ...
    return (
        <section id="instituto-sobre" className="py-24 bg-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
                    ...
                    <div className="order-1 md:order-2 space-y-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {[
                                { title: "Rigor que acolhe", text: "Densidade teórica sem rigidez." },
                                { title: "Presença e awareness", text: "Ampliar a percepção do aqui-agora." },
                ...
                {/* Location */}
                <div className="bg-paper rounded-[3rem] p-8 md:p-16 text-center">
