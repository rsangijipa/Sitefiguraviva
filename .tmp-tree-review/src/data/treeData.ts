import { PetalData, TreeTheme } from "../types";

export const RAW_PETALS: readonly [number, number, number, number, string][] = [
...
// Structural branches with distinct depths and flex weights
export interface BranchSpec {
  id: string;
  d: string;
  width: number;
  depth: "back" | "main" | "front";
  flexFactor: number; // How much this branch oscillates in wind (0 to 1)
  branchGroup: number;
}

export const STRUCTURED_BRANCHES: readonly BranchSpec[] = [
  // Deep trunk
  {
    id: "trunk-base",
    d: "M194 476 C188 438 195 396 189 352 C186 328 179 308 173 294",
    width: 23,
    depth: "main",
    flexFactor: 0.15,
    branchGroup: 0,
  },
  // Major lower right limb
  {
    id: "limb-right-low",
    d: "M192 388 C198 355 221 334 252 319 C282 308 307 290 330 269",
    width: 14,
    depth: "main",
    flexFactor: 0.45,
    branchGroup: 1,
  },
  // Major lower left limb
  {
    id: "limb-left-low",
    d: "M190 359 C174 320 153 301 127 292 C99 286 79 276 64 264",
    width: 11,
    depth: "main",
    flexFactor: 0.42,
    branchGroup: 2,
  },
  // Center trunk extension
  {
    id: "trunk-mid",
    d: "M181 334 C163 302 155 268 163 236 C171 207 165 185 154 160",
    width: 8.5,
    depth: "main",
    flexFactor: 0.55,
    branchGroup: 0,
  },
  // Center right upright limb
  {
    id: "limb-center-up",
    d: "M191 347 C203 310 218 282 216 254 C212 223 226 196 241 169",
    width: 9.5,
    depth: "main",
    flexFactor: 0.6,
    branchGroup: 1,
  },
  // Outer right canopy arm
  {
    id: "branch-right-high",
    d: "M215 271 C241 245 260 218 269 188 C279 156 308 140 329 125",
    width: 5.5,
    depth: "front",
    flexFactor: 0.8,
    branchGroup: 3,
  ...
  {
    id: "branch-apex-1",
    d: "M239 176 C251 141 252 119 249 91 C248 70 255 52 269 40",
    width: 4.2,
    depth: "main",
    flexFactor: 0.9,
    branchGroup: 4,
  ...
  {
    id: "branch-apex-2",
    d: "M250 139 C229 119 216 93 215 64",
    width: 2.8,
    depth: "back",
    flexFactor: 0.85,
    branchGroup: 4,
  ...
  {
    id: "branch-apex-3",
    d: "M262 150 C281 123 310 109 331 105",
    width: 3.2,
    depth: "front",
    flexFactor: 0.88,
    branchGroup: 3,
  ...
  {
    id: "branch-right-mid-1",
    d: "M273 187 C302 169 323 166 349 151",
    width: 3.2,
    depth: "main",
    flexFactor: 0.82,
    branchGroup: 3,
  ...
  {
    id: "branch-right-mid-2",
    d: "M269 213 C289 206 312 204 325 190",
    width: 2.4,
    depth: "front",
    flexFactor: 0.75,
    branchGroup: 3,
  },
  // Left foliage branches
  {
    id: "branch-left-mid",
    d: "M162 236 C145 216 128 198 105 187 C86 178 69 163 65 148",
    width: 4.5,
    depth: "front",
    flexFactor: 0.78,
    branchGroup: 2,
  ...
  {
    id: "branch-left-top",
    d: "M157 174 C143 152 142 127 146 107",
    width: 3.2,
    depth: "back",
    flexFactor: 0.82,
    branchGroup: 2,
  ...
  {
    id: "branch-left-twigs",
    d: "M145 156 C119 147 103 132 93 114",
    width: 2.2,
    depth: "back",
    flexFactor: 0.85,
    branchGroup: 2,
  ...
  {
    id: "branch-low-left-1",
    d: "M129 292 C122 267 104 252 84 239",
    width: 4.2,
    depth: "main",
    flexFactor: 0.65,
    branchGroup: 2,
  ...
  {
    id: "branch-low-left-2",
    d: "M112 283 C84 277 60 249 50 230",
    width: 2.5,
    depth: "back",
    flexFactor: 0.72,
    branchGroup: 2,
  },
  // Far right sweeping branch
  {
    id: "branch-low-right-sweep",
    d: "M251 319 C283 329 316 326 339 318 C356 309 370 307 385 311",
    width: 5.2,
    depth: "main",
    flexFactor: 0.68,
    branchGroup: 1,
  ...
  {
    id: "branch-low-right-sprig",
    d: "M296 326 C318 305 335 292 359 287",
    width: 3.2,
    depth: "front",
    flexFactor: 0.76,
    branchGroup: 1,
  ...
  {
    id: "branch-low-right-up",
    d: "M305 294 C309 272 325 259 341 248",
    width: 3.1,
    depth: "back",
    flexFactor: 0.74,
    branchGroup: 1,
  ...
  {
    id: "branch-inner-diag",
    d: "M215 311 C231 288 251 278 275 272",
    width: 4.1,
    depth: "front",
    flexFactor: 0.58,
    branchGroup: 1,
  ...
  {
    id: "branch-twig-left",
    d: "M128 291 C114 277 111 260 113 247",
    width: 2.2,
    depth: "back",
    flexFactor: 0.62,
    branchGroup: 2,
  ...
  {
    id: "branch-twig-center",
    d: "M218 253 C198 233 187 220 183 198",
    width: 3.1,
    depth: "front",
    flexFactor: 0.72,
    branchGroup: 0,
...
/**
 * Enhanced processed petals with cluster identification, depth and flutter offsets
 */
export const ENHANCED_PETALS: PetalData[] = RAW_PETALS.map(
  ([x, y, angle, scale, color], index) => {
    // Determine cluster based on spatial distribution
    let cluster = 0;
    if (y < 95)
      cluster = 2; // Apex / zenith
    else if (x < 170 && y < 220)
      cluster = 0; // Left upper
    else if (x < 170)
      cluster = 1; // Left lower
    else if (x > 310 && y < 190)
      cluster = 3; // Right upper
    else if (x > 310)
      cluster = 4; // Right lower cascade
    else cluster = 5; // Center heartwood foliage

    // Deterministic pseudo-randomness for phase and flutter frequency
    const phase = (x * 0.05 + y * 0.08 + index * 0.3) % (Math.PI * 2);
    const flutterSpeed = 0.8 + ((index * 37) % 100) * 0.008; // 0.8 to 1.6
    const depth = 0.3 + ((x * 13 + y * 17) % 70) / 100; // 0.3 to 1.0
...
/**
 * Returns color adjusted for chosen theme
 */
export function getThemedColor(
  originalColor: string,
  theme: TreeTheme,
): string {
  if (theme === "figura-viva") return originalColor;

  // Hex to RGB
  const c = originalColor.replace("#", "");
  const r = parseInt(c.substring(0, 2), 16) || 200;
  const g = parseInt(c.substring(2, 4), 16) || 150;
  const b = parseInt(c.substring(4, 6), 16) || 100;
  const luminance = (0.299 * r + 0.587 * g + 0.114 * b) / 255;

  if (theme === "primavera") {
    // Sakura, soft peach, rose and tender greens
    if (r > g) {
      // Warm tones -> cherry blossom pinks & coralline magentas
      ...
      // Green tones -> tender spring sprouts & soft sage
      return luminance > 0.6
        ? "#a3e635"
        : luminance > 0.4
          ? "#4ade80"
  ...
  if (theme === "outono") {
    // Autumn golden amber, burnt orange, crimson, bronze
    if (g > b && g > r * 0.8) {
      return luminance > 0.6
        ? "#fde047"
        : luminance > 0.4
      ...
      return luminance > 0.5 ? "#f59e0b" : "#78350f";
    }
  }

  if (theme === "aurora") {
    // Mystic bioluminescent violet, cyan, electric jade, ultramarine
    if (r > g) {
      return luminance > 0.6
        ? "#c084fc"
        : luminance > 0.4
