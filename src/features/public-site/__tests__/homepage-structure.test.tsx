...
jest.mock("@/components/AlertBar", () => function MockAlertBar() {
  return null;
});
jest.mock(
...
jest.mock("@/components/sections/HeroSection", () => function MockHero() {
...
describe("focused homepage", () => {
  ...
  it("does not mount long-form or interactive homepage sections", () => {
    ...
    expect(screen.queryByText("Biografia da fundadora")).not.toBeInTheDocument();
