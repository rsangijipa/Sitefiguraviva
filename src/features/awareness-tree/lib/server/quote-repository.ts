...
import { getFirebaseAdminDb, isFirebaseAdminConfigured } from "@/features/awareness-tree/lib/firebase/admin";
import type {
  FavoritePayload,
  InteractionPayload,
  Quote,
...
import { TONES } from "@/features/awareness-tree/types/quote";
