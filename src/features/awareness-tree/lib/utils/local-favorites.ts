import { FAVORITES_PREFIX } from "@/features/awareness-tree/lib/utils/storage";
...
export function migrateFavoritesBucket(
  ...
  const merged = mergeFavoriteIds(
    loadFavorites(fromSessionId),
    loadFavorites(toSessionId),
  );
