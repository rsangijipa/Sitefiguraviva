...
export function AwarenessTreeFallback() {
  ...
  return (
    <section className="awareness-tree-fallback" aria-labelledby="fallback-title">
      <div className="awareness-tree-fallback__glow" aria-hidden="true" />
      <div className="awareness-tree-fallback__content">
        <p className="awareness-tree-fallback__eyebrow">Recurso contemplativo</p>
        ...
        <div className="awareness-tree-fallback__themes" aria-label="Temas emocionais">
