...
import { LeafMessageCard } from "@/features/awareness-tree/components/ui/LeafMessageCard";
import { ThemeFilter } from "@/features/awareness-tree/components/ui/ThemeFilter";
import { themeLabel } from "@/features/awareness-tree/data/labels";
import { THEMES } from "@/features/awareness-tree/data/themes";
import { usePerformanceMode } from "@/features/awareness-tree/hooks/usePerformanceMode";
...
export function ExperienceRoot() {
  ...
  return (
    <section
      className="awareness-tree relative h-dvh w-full overflow-hidden bg-[#0D1422] text-[#EAF2FB]"
      aria-labelledby="awareness-tree-title"
    >
      <h1 id="awareness-tree-title" className="sr-only">
