    ...
    <section id="clinica" className="py-24 md:py-48 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-20 lg:gap-32 items-center">
        <motion.div
          ...
          className="relative"
        >
          <div className="relative z-10 overflow-hidden rounded-organic-1">
            <motion.img
        ...
        >
          <span className="text-accent font-bold uppercase tracking-[0.3em] text-[10px] mb-8 block">
            Espaço Clínico
          </span>
          <h2 className="heading-section mb-10 text-balance">
            A Arte da <br />
            <span className="italic text-gold italic font-light">Presença</span>
          </h2>
          <p className="text-primary/70 mb-12 leading-relaxed font-light text-xl text-balance">
            Na Gestalt-Terapia, não buscamos apenas "consertar" o que está
            errado. Buscamos ampliar a{" "}
            <span className="text-primary font-medium italic">awareness</span>{" "}
            sobre como você existe no mundo aqui e agora.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <motion.button
              ...
              className={buttonVariants({
                ...
                size: "lg",
                className:
                  "bg-[#25D366] hover:bg-[#20bd5a] text-white shadow-xl shadow-green-900/10 hover:shadow-green-900/20 rounded-2xl gap-4",
              })}
            >
