      ...
      <div className="w-1/3 border-r border-stone-100 flex flex-col bg-stone-50/30">
        ...
        <div className="flex-1 overflow-y-auto p-2 space-y-2">
          ...
          {materials.map((mat) => (
            <div
              key={mat.id}
              className="p-3 bg-white rounded-lg border border-stone-100 shadow-sm hover:shadow-md transition-all group relative"
            >
      ...
      <div className="flex-1 bg-white p-8">
        {isAdding ? (
          <div className="max-w-md mx-auto">
            ...
            <form onSubmit={handleAdd} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <option value="link">
                    Link Externo (Drive, Dropbox, Youtube)
                  </option>
          ...
          <div className="h-full flex flex-col items-center justify-center text-stone-300">
            ...
            <p>
              Selecione "Adicionar Material" para incluir conteúdo complementar.
            </p>
          </div>
        )}
      </div>
