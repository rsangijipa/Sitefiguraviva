...
const SensationButton: React.FC<SensationButtonProps> = ({ type, selectedSensation, onSelect }) => {
          ...
          <div className="bg-[#fafaf9] border border-white/50 rounded-[2.5rem] p-8 w-full max-w-sm shadow-2xl space-y-6 relative overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="overflow-y-auto no-scrollbar py-1 relative z-10">
              <div className="grid grid-cols-2 gap-3">
                <SensationButton type="tension" selectedSensation={tempSensation} onSelect={setTempSensation} />
                <SensationButton type="heat" selectedSensation={tempSensation} onSelect={setTempSensation} />
                <SensationButton type="weight" selectedSensation={tempSensation} onSelect={setTempSensation} />
                <SensationButton type="tingling" selectedSensation={tempSensation} onSelect={setTempSensation} />
                <div className="col-span-2">
                  <SensationButton type="neutral" selectedSensation={tempSensation} onSelect={setTempSensation} />
                </div>
              </div>
            </div>
