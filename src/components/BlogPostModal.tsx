            ...
            <div className="relative">
              ...
              <div className="px-6 py-8 md:px-12 md:py-12 -mt-12 relative z-10">
                <div className="max-w-3xl mx-auto">
                  ...
                  <h1 className="font-serif text-fluid-h2 text-primary leading-tight mb-8">
                    {post.title}
                  </h1>
                    ...
                    post.tags.length > 0 && (
                      <div className="mt-12 pt-8 border-t border-stone-100 flex flex-wrap gap-2">
                        {(Array.isArray(post.tags)
                          ...
                          <span
                            key={tag}
                            className="px-3 py-1 bg-primary/5 text-primary rounded-full text-[10px] font-bold uppercase tracking-widest"
                          >
                            {tag}
                          </span>
                        ))}
