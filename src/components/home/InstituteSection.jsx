...
export default function InstituteSection({ courses = [], onOpenCalendar, loading = false }) {
            ...
            <div className="container mx-auto max-w-6xl">
                ...
                >
                    ...
                    <div className="hidden md:block">
                        {/* Desktop 'View Calendar' moved near title or keep hidden if desired, kept hidden in mobile view logic below */}
                    </div>
                </motion.div>

                {/* Horizontal Scroll Container Group */}
