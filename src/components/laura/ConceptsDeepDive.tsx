      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <div className="w-10 h-10 rounded-full bg-[#1b140d] border-2 border-[#c9a768] flex items-center justify-center">
              <BookOpen size={20} className="text-[#e6d7bd]" />
            </div>
            <div className="h-px w-12 bg-[#c9a768]/60" />
          </div>
              ...
              >
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="p-2"
                  >
                    <ChevronDown size={24} className="text-[#d4b578]" />
                  </motion.div>
                </button>
                            ...
                            <div className="space-y-4">
                              {concept.data.components.map((comp, i) => (
                                ...
                                >
                                  ...
                                  <div>
                                    <span className="font-bold text-[#e6d7bd] block">
                                      {comp.name}
                                    </span>
                                    <span className="text-sm text-[#cbb896]">
                                      {comp.description}
                                    </span>
                                  </div>
                                </div>
                            ...
                            <div className="space-y-3">
                              {concept.data.clinicalApplications.map(
                                (app, i) => (
                                  ...
                                  >
                                    <div className="w-6 h-6 rounded-full bg-[#c9a768]/10 flex items-center justify-center shrink-0 mt-0.5">
                                      <span className="text-[10px] text-[#e6d7bd]">
                                        ✓
                                      </span>
                                    </div>
                                    <span className="text-[#cbb896] leading-relaxed">
                                      {app}
                                    </span>
                                  </div>
                                ),
