...
export function NewTopicModal({ isOpen, onClose }: NewTopicModalProps) {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <ModalContent>
                <ModalHeader>
                    <h2 className="font-serif text-xl font-bold text-stone-800">Novo Tópico</h2>
                </ModalHeader>
                <ModalBody>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-stone-600">Canal</label>
                            <select
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-stone-600">Conteúdo</label>
                            <textarea
