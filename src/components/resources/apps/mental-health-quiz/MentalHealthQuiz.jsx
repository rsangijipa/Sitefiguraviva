...
const QUESTIONS = [
  {
    id: 1,
    text: "Senti pouca energia ou cansaço que não passa.",
    isInverse: false,
  },
  {
    id: 2,
    text: "Tive dificuldade para dormir (pegar no sono, manter, ou acordei cedo demais).",
    isInverse: false,
  },
  {
    id: 3,
    text: "Me senti ansioso(a), tenso(a) ou “no modo alerta”.",
    isInverse: false,
  },
  {
    id: 4,
    text: "Tive pensamentos acelerados ou dificuldade de desligar a mente.",
    isInverse: false,
  },
  {
    id: 5,
    text: "Me senti triste, desanimado(a) ou sem esperança.",
    isInverse: false,
  },
  {
    id: 6,
    text: "Perdi interesse/prazer em coisas que normalmente gosto.",
    isInverse: false,
  },
  {
    id: 7,
    text: "Me senti irritado(a) com facilidade (pavio curto).",
    isInverse: false,
  },
  {
    id: 8,
    text: "Tive dificuldade de concentração (ler, trabalhar, conversar).",
    isInverse: false,
  },
  {
    id: 9,
    text: "Evitei pessoas/atividades por falta de vontade ou medo/desconforto.",
    isInverse: false,
  },
  {
    id: 10,
    text: "Senti culpa excessiva ou me cobrei além do limite.",
    isInverse: false,
  },
  {
    id: 11,
    text: "Me senti sobrecarregado(a), como se “não desse conta”.",
    isInverse: false,
  },
  {
    id: 12,
    text: "Usei comida, álcool, telas ou compras como fuga com frequência.",
    isInverse: false,
  },
  {
    id: 13,
    text: "Senti sintomas físicos por estresse (tensão, dor de cabeça, nó no peito/estômago).",
    isInverse: false,
  },
  {
    id: 14,
    text: "Notei que pequenas coisas viraram grandes problemas na minha cabeça.",
    isInverse: false,
  },
  {
    id: 15,
    text: "Consegui fazer pausas e me recuperar quando algo me estressou.",
    isInverse: true,
  },
  {
    id: 16,
    text: "Senti que tenho alguém (ou algum lugar) onde posso buscar apoio.",
    isInverse: true,
  },
];
...
const BONUS_QUESTION =
  "Nas últimas 2 semanas, pensei que seria melhor não existir, me machucar, ou tive ideia de suicídio?";
...
const getResultData = (score) => {
  if (score <= 12) {
    return {
      ...
      title: "Zona Verde",
      description:
        "Sinais leves ou esperados do dia a dia. Você parece estar lidando bem com os desafios atuais.",
      actionPlan:
        "Manter hábitos base: sono regular, boa alimentação, movimento, contato social e pausas.",
    };
  } else if (score <= 24) {
    return {
      zone: "yellow",
      ...
      title: "Zona Amarela",
      description:
        "Atenção. O estresse, ansiedade ou humor podem estar começando a impactar sua rotina.",
      actionPlan:
        "Escolha 2 alavancas: Priorize o sono + estabeleça limites (tempo de tela/agenda) pelos próximos 7 dias.",
    };
  } else if (score <= 36) {
    return {
      zone: "orange",
      ...
      title: "Zona Laranja",
      description:
        "Impacto moderado a alto. Seus sintomas estão consumindo energia significativa.",
      actionPlan:
        "Adicionar apoio (terapia ou escuta ativa) + reduzir a carga imediatamente (delegar tarefas ou cortar excessos).",
    };
  } else {
    return {
      zone: "red",
      ...
      title: "Zona Vermelha",
      description:
        "Impacto alto na qualidade de vida. É importante não enfrentar isso sozinho(a).",
      actionPlan:
        "Apoio profissional + rede de segurança (não ficar sozinho(a) em momentos de crise, ativar plano de emergência).",
    };
  }
};
        ...
        {!isBonusStep && currentQuestion ? (
          <>
            ...
            <div className="grid gap-3">
              {ANSWER_OPTIONS.map((option) => (
                ...
                >
                  <div
                    className={`w-6 h-6 rounded-full border-2 border-gray-200 group-hover:border-accent flex items-center justify-center transition-colors`}
                  >
          ...
          <div className="text-center animate-fade-in">
            ...
            <p className="mt-6 text-sm text-gray-400 italic">
              Esta resposta é confidencial e ajuda a direcionar o suporte
              adequado.
            </p>
          </div>
        )}
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 py-8 animate-fade-in pb-20 relative z-10 overflow-y-auto max-h-[90vh]">
      ...
      <div className="text-center mb-10">
        ...
        <h2
          className={`text-4xl md:text-5xl font-serif mb-4 capitalize text-primary`}
        >
          {data.title}
        </h2>
      ...
      {bonusAlert && (
        <div className="mb-8 bg-red-50 border border-red-200 p-6 md:p-8 rounded-3xl flex flex-col items-center text-center animate-pulse">
          <h3 className="text-red-800 font-serif text-xl font-bold mb-2">
            Atenção Prioritária
          </h3>
          <p className="text-red-700 mb-6 leading-relaxed">
            Você indicou pensamentos de risco. Isso é uma emergência
            médica/emocional e deve ser tratada agora.
          </p>
      ...
      {/* Main Result Card */}
      <div
        className={`relative overflow-hidden rounded-3xl p-8 md:p-12 mb-8 border ${COLOR_MAP[data.zone]}`}
      >
        <div className="relative z-10">
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-current/10">
            ...
            <p className="font-sans leading-relaxed">{data.actionPlan}</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center gap-6">
        <p className="text-center text-gray-400 text-sm max-w-md">
          *Este questionário é uma ferramenta de triagem e autoconhecimento, não
          substitui um diagnóstico profissional.
        </p>
...
export default function MentalHealthQuiz({ onClose: _onClose }) {
  ...
  return (
    <div className="w-full h-full min-h-0 overflow-y-auto bg-stone-50 flex flex-col relative animate-fade-in">
      <div className="flex-1 min-h-0 flex flex-col items-center justify-center py-20">
        ...
        {view === "intro" && (
          <div className="flex flex-col items-center justify-center px-6 text-center animate-fade-in max-w-2xl mx-auto w-full">
            ...
            <p className="text-lg text-gray-500 max-w-xl mb-12 leading-relaxed">
              Um check-in rápido e gentil consigo mesmo. Avalie seus últimos 14
              dias para entender em qual zona emocional você está.
            </p>
        ...
        {view === "quiz" && (
          <Quiz onComplete={handleQuizComplete} onCancel={resetQuiz} />
        )}
