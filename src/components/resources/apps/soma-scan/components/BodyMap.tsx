...
const getFillColor = (
  ...
  switch (sensation) {
    case "tension":
      return `rgba(192, 130, 103, ${opacity})`; // Clay
    case "heat":
      return `rgba(212, 163, 115, ${opacity})`; // Ochre
    case "weight":
      return `rgba(100, 116, 139, ${opacity})`; // Ocean
    case "tingling":
      return `rgba(217, 185, 155, ${opacity})`; // Sand
    case "numbness":
      return `rgba(168, 162, 158, ${opacity})`; // Stone
    case "neutral":
      return `rgba(141, 163, 153, ${opacity})`; // Sage
    default:
      return "rgba(231, 229, 228, 0.4)";
  }
};
...
const BodyMap: React.FC<BodyMapProps> = ({
  ...
  const paths = {
    ...
    chest:
      "M132,142 Q150,148 168,142 L205,152 Q212,170 202,215 L195,245 L105,245 L98,215 Q88,170 95,152 Z",
    stomach:
      "M105,245 L195,245 L198,285 Q205,315 150,325 Q95,315 102,285 L105,245 Z",
    leftArm:
      "M95,152 Q80,165 72,210 L65,280 L55,340 L75,350 L85,340 L95,280 Q102,215 98,215 L105,245 L98,215 Z", // Simplified contour
    // Refined separate Left Arm
    leftArmReal:
      "M92,155 Q80,158 70,200 Q65,240 60,280 L52,330 L65,345 L78,330 L85,280 Q92,230 102,220 Z",
    rightArmReal:
      "M208,155 Q220,158 230,200 Q235,240 240,280 L248,330 L235,345 L222,330 L215,280 Q208,230 198,220 Z",

    leftLeg:
      "M102,285 Q90,305 92,380 Q94,450 95,580 L135,580 Q140,450 142,380 Q145,325 150,325 Z",
    rightLeg:
      "M198,285 Q210,305 208,380 Q206,450 205,580 L165,580 Q160,450 158,380 Q155,325 150,325 Z",
  ...
  const renderBackPath = (d: string) => <path d={d} className={baseClass} />;
