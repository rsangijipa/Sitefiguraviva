...
import { QUOTES } from "@/components/resources/apps/emotion-tree/data/quotes";
import { THEMES } from "@/components/resources/apps/emotion-tree/data/themes";
import { getFirebaseAdminDb, isFirebaseAdminConfigured } from "@/components/resources/apps/emotion-tree/lib/firebase/admin";
import type {
  FavoritePayload,
  InteractionPayload,
  Quote,
...
import { TONES } from "@/components/resources/apps/emotion-tree/types/quote";
