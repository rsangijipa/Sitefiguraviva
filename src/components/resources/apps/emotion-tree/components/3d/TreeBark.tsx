...
import { buildBarkGeometry } from "@/components/resources/apps/emotion-tree/lib/tree/barkGeometry";
import type { BranchSegment } from "@/components/resources/apps/emotion-tree/lib/tree/generateTree";
