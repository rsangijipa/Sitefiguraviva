...
import { createLeafVariants } from "@/components/resources/apps/emotion-tree/lib/tree/leafGeometry";
import { createLeafMaterial, updateSunDirection } from "@/components/resources/apps/emotion-tree/lib/tree/leafMaterial";
