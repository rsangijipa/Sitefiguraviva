...
import { FlyingLeaf, type FlyingLeafPhase } from "@/components/resources/apps/emotion-tree/components/3d/FlyingLeaf";
import { Foliage } from "@/components/resources/apps/emotion-tree/components/3d/Foliage";
import { Panorama } from "@/components/resources/apps/emotion-tree/components/3d/Panorama";
import { TreeBark } from "@/components/resources/apps/emotion-tree/components/3d/TreeBark";
import { WindParticles } from "@/components/resources/apps/emotion-tree/components/3d/WindParticles";
import { GRASS_FAR_COLOR, GRASS_NEAR_COLOR, HORIZON_COLOR } from "@/components/resources/apps/emotion-tree/lib/theme/panorama";
import {
  MESSAGE_LEAF_COUNT,
  SCENE_QUALITY_CONFIGS,
  SUN_CAMERA_YAW,
  SUN_POSITION,
} from "@/components/resources/apps/emotion-tree/lib/theme/scene-tokens";
import { generateTree } from "@/components/resources/apps/emotion-tree/lib/tree/generateTree";
import type { QualityConfig, QualityProfile } from "@/components/resources/apps/emotion-tree/types/performance";
