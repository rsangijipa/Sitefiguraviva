...
const Tip: React.FC<{ label: string; children: React.ReactNode }> = ({
  label,
  children,
}) => (
...
export const PondControls: React.FC<PondControlsProps> = ({
  ...
  const cycleRain = () => {
    ...
    onChangeConfig((prev) => ({
      ...prev,
      rainIntensity: nextMap[prev.rainIntensity],
    }));
  };
    ...
    <div className="absolute bottom-5 left-1/2 -translate-x-1/2 z-30 w-full max-w-xl px-4 pointer-events-none select-none">
      <div className="pointer-events-auto flex flex-col items-center gap-2">
          ...
          >
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-xs">
              ...
              <div className="flex flex-col gap-2">
                <span className="text-text/50 font-medium uppercase tracking-wider text-[10px]">
                  Elementos
                </span>
              ...
              <div className="flex flex-col gap-2 col-span-2 sm:col-span-1">
                <div className="flex justify-between text-[10px]">
                  <span className="text-text/50 uppercase tracking-wider font-medium">
                    Persistência da Onda
                  </span>
                ...
                />
                <span
                  id="wave-damping-description"
                  className="text-[10px] text-text/50"
                >
              ...
              <div className="col-span-2 sm:col-span-3 flex flex-col gap-2">
                <label
                  ...
                  className="text-text/50 font-medium uppercase tracking-wider text-[10px]"
                >
                  Qualidade visual
                </label>
                <select
        ...
        >
          ...
          <div
            className="w-px h-5 bg-stone-200 mx-0.5 flex-none"
            aria-hidden="true"
          />
          ...
          <Tip label={config.soundEnabled ? "Áudio ligado" : "Áudio mudo"}>
            <button
              ...
              aria-label={
                config.soundEnabled ? "Desativar áudio" : "Ativar áudio"
              }
              disabled={!audioStatus.available}
              title={
                audioStatus.error ??
                (audioStatus.available ? "Áudio" : "Áudio indisponível")
              }
          ...
          {!audioStatus.available && (
            <span
              className="hidden max-w-32 truncate px-1 text-[10px] text-warning sm:inline"
              role="status"
            >
              Áudio indisponível
            </span>
