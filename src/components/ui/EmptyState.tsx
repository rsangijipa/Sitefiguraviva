  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="w-20 h-20 bg-stone-50 border border-stone-100 rounded-full flex items-center justify-center mb-6 text-stone-300 shadow-inner animate-float-soft">
          {icon}
        </div>

        <h3 className="font-serif text-2xl text-primary mb-3 text-balance">
          {title}
        </h3>

        <p className="text-stone-400 max-w-sm mx-auto mb-8 font-light text-sm leading-relaxed text-balance">
          {description}
        </p>
