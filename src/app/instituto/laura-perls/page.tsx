...
export const metadata: Metadata = {
  ...
  openGraph: { title: lauraPerlsContent.meta.title, description: lauraPerlsContent.meta.description, type: "article", images: ["/laura/laura1.jpg"] },
};
...
export default function LauraPerlsPage() {
  return (
    <div className="laura-viva fv-bg fv-bg-laura-archive relative min-h-screen bg-[#FDFAF4] text-[#262B22]">
      <div className="fixed inset-0 z-[9999] pointer-events-none opacity-[0.035]" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E")` }} />
