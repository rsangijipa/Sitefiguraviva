...
export default function GoogleIntegrations() {
  ...
  const integrationFields = [
    {
      ...
      placeholder: "ex: pt.brazilian#holiday@group.v...",
      help: "ID do calendário público para exibir na Home.",
    },
    {
      key: "driveFolderId",
      label: "Google Drive Folder ID",
      placeholder: "ex: 1A2b3C...",
      help: "ID da pasta onde estão os materiais dos alunos.",
    },
    {
      key: "formsUrl",
      label: "Google Forms URL",
      placeholder: "https://docs.google.com/forms/...",
      help: "Link direto para o formulário de anamnese.",
    },
    {
      key: "youtubeId",
      label: "YouTube Channel/Video ID",
      placeholder: "ID do canal ou vídeo destaque",
      help: "Para futuras integrações de vídeo.",
    },
  ];
  ...
  return (
    <div className="relative">
      ...
      <AnimatePresence>
        {toast && (
          <motion.div
            ...
            className={`fixed top-10 left-1/2 z-50 px-6 py-4 rounded-xl shadow-2xl flex items-center gap-3 backdrop-blur-md border ${
              toast.type === "success"
      ...
      <div className="bg-white p-10 rounded-[2.5rem] border border-primary/5">
