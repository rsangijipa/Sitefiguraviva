                    ...
                    <div className="flex flex-col items-center mb-8 animate-fade-in-up">
                        {isAdmin ? (
                            <>
                                ...
                                <h2 className="font-serif text-2xl text-primary mb-2">Acesso Autorizado</h2>
                                <p className="text-primary/60 mb-8 text-sm">Você está logado como administrador.</p>
                            ...
                            <>
                                ...
                                <h2 className="font-serif text-2xl text-primary mb-2">Acesso Negado</h2>
