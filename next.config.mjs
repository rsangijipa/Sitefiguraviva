        ...
        const securityHeaders = [
            ...
            { key: 'Referrer-Policy', value: 'strict-origin-when-cross-origin' },
            {
                ...
                value: [
                    ...
                    "img-src 'self' data: https://*.supabase.co https://firebasestorage.googleapis.com https://*.firebasestorage.app https://storage.googleapis.com https://lh3.googleusercontent.com https://img.youtube.com https://i.ytimg.com https://*.behold.so https://www.transparenttextures.com",
                    "media-src 'self' blob: data: https://firebasestorage.googleapis.com https://*.firebasestorage.app https://storage.googleapis.com",
                    "font-src 'self' data:",
