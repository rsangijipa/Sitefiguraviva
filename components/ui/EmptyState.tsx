...
export default function EmptyState({
    ...
    return (
        <div className={cn("flex flex-col items-center justify-center text-center p-12 bg-white/30 dark:bg-white/5 backdrop-blur-sm rounded-[2.5rem] border border-stone-200/50 dark:border-white/5 shadow-soft-xl", className)}>
            <motion.div
            ...
            >
                ...
                <div className="absolute inset-0 bg-gold/10 dark:bg-gold/5 blur-3xl rounded-full" />

                {icon ? (
                    <div className="relative z-10 text-gold/40 dark:text-gold/20 flex items-center justify-center">
                        {icon}
                    </div>
                ) : (
                    <svg
                        viewBox="0 0 200 200"
                        className="w-32 h-32 text-gold/20 dark:text-gold/10 relative z-10"
                        fill="currentColor"
                    >
